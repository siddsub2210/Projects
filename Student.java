...
public class Student extends Patron /*implements Operations */{
    protected int maxBooks = 5;
    protected float maxTime = 62f;
    protected final float DISCOUNT = 0.2f;
    protected final float finePerDay = 10.0f;

    // Constructor for Student class
    public Student(String n, String pn, int m, boolean p, boolean d, int n_times){
        super(n, pn, m, "Student", p, d, n_times);
        this.name = n;
        this.phoneNumber = pn;
        this.membershipid = m;
        this.subscriptionType = "Student";
    ...
    public void renew(Book book, int months){
        try{
            ...
            System.out.println("This is the "+n+"th time you have missed the book renewal");
            //defaulter, if n>3;
            if (n>3){
    ...
    public void getInsights() {
        ...
        System.out.println("Insights for Working Student: ");
    ...
    public void renewPlan(int months){
        ...
        if (!this.getPaymentStatus()){
            ...
            System.out.println("Membership fee for students is "+Patron.FEES);
            System.out.println("Discount is "+this.DISCOUNT*Patron.FEES);
